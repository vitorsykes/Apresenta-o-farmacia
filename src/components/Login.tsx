...
import { Mail, Lock, Eye, EyeOff, Key, User as UserIcon, LogIn, ArrowLeft } from "lucide-react";
...
export default function Login({ onLoginSuccess }: LoginProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await api.login("eufui.turismo.contato@gmail.com", undefined, "google-mock-token");
      onLoginSuccess(response.user);
    } catch (err: any) {
